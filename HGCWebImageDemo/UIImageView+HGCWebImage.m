                      ...
                      cornerRadii:(CGFloat)radius
{
     ...
     *  首先过滤空白URL
     */
    if (urlstring == nil || [[urlstring stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] isEqualToString:@""]) {
                 ...
                 cornerRadii:(CGFloat)radius
{
     ...
     *  首先过滤空白图片名
     */
    if (imgName == nil || [[imgName stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] isEqualToString:@""]) {
